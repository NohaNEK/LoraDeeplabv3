...
from datasets import VOCSegmentation, Cityscapes, GTA
...
def main():
    ...
    writer = SummaryWriter("/media/fahad/DATA_2/ckpt_deeplabv3/R101_CS_freezed_cls_org_100K_768x768")
    ...
    # print(f"After freezing backbone Total trainable parameters: {trainable_params2}")
    ...
    utils.mkdir('checkpoints_r101_cs_freezed_cls')
    # Restore
    best_score = 0.0
    cur_itrs = 0
    cur_epochs = 0
    ...
    while True:  # cur_itrs < opts.total_itrs:
        ...
        for (images, labels) in train_loader:
            ...
            if (cur_itrs) % opts.val_interval == 0:
                save_ckpt('checkpoints_r101_cs_freezed_cls/latest_%s_%s_os%d.pth' %
                ...
                if val_score['Mean IoU'] > best_score:  # save best model
                    ...
                    save_ckpt('checkpoints_r101_cs_freezed_cls/best_%s_%s_os%d.pth' %
                              (opts.model, opts.dataset, opts.output_stride))
